...
subprojects {
    ...
    aliucord {
        ...
        updateUrl.set("https://raw.githubusercontent.com/scrazzz/AliucordPlugins/builds/updater.json")
        buildUrl.set("https://raw.githubusercontent.com/scrazzz/AliucordPlugins/builds/%s.zip")
    }
